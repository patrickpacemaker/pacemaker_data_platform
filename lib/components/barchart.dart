...
class _DataLabelDefaultState extends SampleViewState {
  ...
  void initState() {
    ...
    chartData = <ChartSampleData>[
      ChartSampleData(x: "22.08.2023", y: 21.8, yValue: 18.2),
      ChartSampleData(x: "22.08.2023", y: 24.9, yValue: 21),
      ChartSampleData(x: "22.08.2023", y: 28.5, yValue: 22.1),
      ChartSampleData(x: "22.08.2023", y: 27.2, yValue: 21.5),
      ChartSampleData(x: "22.08.2023", y: 23.4, yValue: 18.9),
      ChartSampleData(x: "22.08.2023", y: 23.4, yValue: 21.3)
    ];
    super.initState();
  }
